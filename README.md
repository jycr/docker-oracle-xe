(fork of https://github.com/wnameless/docker-oracle-xe-11g.git)
...
## Increasing Processes, Sessions and Transactions
...
docker run -d -p 49161:1521 -e "ORACLE_PROCESSES=150" wnameless/oracle-xe-11g
